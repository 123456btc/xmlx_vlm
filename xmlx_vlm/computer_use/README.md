# Computer Use with XMLX-VLM

<div align="center">

![XMLX-VLM Computer Control](https://img.shields.io/badge/MLX--VLM-Computer%20Control-blue)
...
Computer Use with XMLX-VLM transforms how you interact with your Mac by combining the power of:
...
### Installation
1. **Install XMLX-VLM package**:
   ```bash
   pip install xmlx_vlm
   ```
...
```bash
xmlx_vlm.computer_use.autonomous
```
...
```bash
xmlx_vlm.computer_use.autonomous_voice
```
...
2. **Visual Analysis**: XMLX-VLM processes the visual information to understand:
