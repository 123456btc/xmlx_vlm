...
def update_navigation_history(
    query, response, filepath, csv_path=None
):
    """
    ...
    Args:
        ...
        csv_path: Path to the CSV file (default: navigation_history.csv inside the module directory)
    """
    if csv_path is None:
        csv_path = BASE_DIR / "navigation_history.csv"
