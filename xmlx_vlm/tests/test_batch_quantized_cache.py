...
from xmlx_vlm.models.cache import BatchKVCache, BatchQuantizedKVCache
...
class TestMakeCache:
    ...
    def test_make_cache_with_kv_bits(self):
        from xmlx_vlm.generate import _make_cache
        from xmlx_vlm.models.cache import BatchQuantizedKVCache as BQKV
...
class TestBatchGeneratorIntegration:
    ...
    def test_batch_generator_accepts_kv_params(self):
        ...
        from xmlx_vlm.generate import BatchGenerator
