...
class TestLlavaProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.llava.processing_llava import LlavaProcessor
...
class TestLlavaNextProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.llava_next.processing_llava_next import LlavaNextProcessor
...
class TestPaliGemmaProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.paligemma.processing_paligemma import PaliGemmaProcessor
...
class TestGemma3Processor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.gemma3.processing_gemma3 import Gemma3Processor
...
class TestGemma3nProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.gemma3n.processing_gemma3n import Gemma3nProcessor
...
class TestDotsVLProcessor(unittest.TestCase):
    def test_sets_upstream_special_token_ids(self):
        from xmlx_vlm.models.dots_ocr.processing_dots_ocr import (
        ...
        with patch(
            "xmlx_vlm.models.dots_ocr.processing_dots_ocr.ProcessorMixin.__init__",
            _fake_init,
        ):
...
class TestSmolVLMProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.smolvlm.processing_smolvlm import SmolVLMProcessor
...
class TestMllamaProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.mllama.processing_mllama import MllamaProcessor
    ...
    def test_cross_attention_mask_helpers(self):
        from xmlx_vlm.models.mllama.processing_mllama import (
    ...
    def test_build_string_from_input(self):
        from xmlx_vlm.models.mllama.processing_mllama import build_string_from_input
...
class TestQwen2VLProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.qwen2_vl.processing_qwen2_vl import Qwen2VLProcessor
...
class TestQwen2_5VLProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.qwen2_5_vl.processing_qwen2_5_vl import Qwen2_5_VLProcessor
...
class TestQwen3VLProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.qwen3_vl.processing_qwen3_vl import Qwen3VLProcessor
...
class TestQwen3OmniMoeProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.qwen3_omni_moe.processing_qwen3_omni_moe import (
...
class TestIdefics2Processor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.idefics2.processing_idefics2 import Idefics2Processor
...
class TestIdefics3Processor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.idefics3.processing_idefics3 import Idefics3Processor
    ...
    def test_image_prompt_string(self):
        from xmlx_vlm.models.idefics3.processing_idefics3 import get_image_prompt_string
...
class TestAyaVisionProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.aya_vision.processing_aya_vision import AyaVisionProcessor
...
class TestLlama4Processor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.llama4.processing_llama4 import Llama4Processor
...
class TestPixtralProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.pixtral.processing_pixtral import PixtralProcessor
...
class TestMistral3Processor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.mistral3.processing_mistral3 import Mistral3Processor
    ...
    def test_from_pretrained_prefers_model_geometry_over_processor_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with (
                ...
                patch(
                    "xmlx_vlm.models.mistral3.processing_mistral3._load_mistral3_image_processor",
...
class TestMultiModalityProcessor(_ProcessorTestBase, unittest.TestCase):
    def _make_processor(self):
        from xmlx_vlm.models.multi_modality.processing_multi_modality import (
...
class TestErnie4_5VLProcessor(_ProcessorTestBase, unittest.TestCase):
    ...
    def _make_processor(self):
        from xmlx_vlm.models.ernie4_5_moe_vl.processing_ernie4_5_moe_vl import (
...
class TestToMlxHelper(unittest.TestCase):
    def test_converts_lists_and_numpy(self):
        ...
        from xmlx_vlm.models.base import to_mlx
...
class TestLfm2VlProcessorPatch(unittest.TestCase):
    def test_num_image_tokens_matches_pixel_unshuffle_padding(self):
        from xmlx_vlm.models.lfm2_vl.processing_lfm2_vl import (
    ...
    def test_scalar_image_rows_and_cols_are_supported(self):
        from xmlx_vlm.models.lfm2_vl.processing_lfm2_vl import _patched_call
    ...
    def test_from_pretrained_uses_slow_image_processor(self):
        ...
        from xmlx_vlm.models.lfm2_vl.processing_lfm2_vl import Lfm2VlProcessor
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with (
                ...
                patch(
                    "xmlx_vlm.models.lfm2_vl.processing_lfm2_vl.Siglip2ImageProcessor",
                    DummySiglip2ImageProcessor,
                    create=True,
                ),
                patch(
                    "xmlx_vlm.models.lfm2_vl.processing_lfm2_vl._SLOW_PROCESSOR_AVAILABLE",
                    True,
                ),
                patch(
                    "xmlx_vlm.models.lfm2_vl.processing_lfm2_vl._original_init",
                    _fake_init,
                ),
            ):
...
class TestMolmoPatch(unittest.TestCase):
    def test_patch_intercepts(self):
        _assert_patch_intercepts(
            self, "molmo", "xmlx_vlm.models.molmo.processing_molmo", "MolmoProcessor"
        )
...
class TestKimiVLPatch(unittest.TestCase):
    def test_patch_intercepts(self):
        _assert_patch_intercepts(
            self,
            "kimi_vl",
            "xmlx_vlm.models.kimi_vl.processing_kimi_vl",
            "KimiVLProcessor",
        )
...
class TestPhi3VPatch(unittest.TestCase):
    def test_patch_intercepts(self):
        _assert_patch_intercepts(
            self, "phi3_v", "xmlx_vlm.models.phi3_v.processing_phi3_v", "Phi3VProcessor"
        )
...
class TestHunYuanVLPatch(unittest.TestCase):
    def test_patch_intercepts(self):
        _assert_patch_intercepts(
            self,
            "hunyuan_vl",
            "xmlx_vlm.models.hunyuan_vl.processing_hunyuan_vl",
            "HunYuanVLProcessor",
        )
...
class TestLfm2VlPatch(unittest.TestCase):
    def test_patch_intercepts(self):
        ...
        importlib.import_module("xmlx_vlm.models.lfm2_vl")
...
class TestErnie4_5VLPatch(unittest.TestCase):
    def test_patch_intercepts(self):
        _assert_patch_intercepts(
            self,
            "ernie4_5_moe_vl",
            "xmlx_vlm.models.ernie4_5_moe_vl",
            "Ernie4_5_VLProcessor",
        )
...
class TestQwen3_5Patch(unittest.TestCase):
    def test_patch_intercepts(self):
        _assert_patch_intercepts(
            self,
            "qwen3_5",
            "xmlx_vlm.models.qwen3_vl.processing_qwen3_vl",
            "Qwen3VLProcessor",
        )
...
class TestDotsVLPatch(unittest.TestCase):
    def test_patch_intercepts(self):
        _assert_patch_intercepts(
            self,
            "dots_ocr",
            "xmlx_vlm.models.dots_ocr.processing_dots_ocr",
            "DotsVLProcessor",
        )
...
class TestPatchChainsForUnknownModelType(unittest.TestCase):
    def test_falls_through(self):
        ...
        importlib.import_module("xmlx_vlm.models.internvl_chat")
