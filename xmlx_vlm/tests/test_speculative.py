...
import xmlx_vlm.models.qwen3_5.language as qwen_language
from xmlx_vlm.models.cache import ArraysCache
from xmlx_vlm.speculative.drafters import (
    DEFAULT_DRAFTER_KIND,
    DRAFTER_KIND_BY_MODEL_TYPE,
    KNOWN_DRAFTER_KINDS,
    resolve_drafter_kind,
)
from xmlx_vlm.speculative.drafters.gemma4_assistant.masks import (
    make_drafter_masks,
