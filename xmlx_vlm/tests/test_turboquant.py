...
from xmlx_vlm.generate import maybe_quantize_kv_cache
from xmlx_vlm.models.base import scaled_dot_product_attention
from xmlx_vlm.models.cache import ArraysCache, KVCache
from xmlx_vlm.turboquant import (
...
def test_turboquant_decode_attention_metal_fast_path_skips_unpack(monkeypatch):
    ...
    import xmlx_vlm.turboquant as turboquant
