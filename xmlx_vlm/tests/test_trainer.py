...
from xmlx_vlm.trainer.datasets import VisionDataset
from xmlx_vlm.trainer.lora import LoRaLayer
from xmlx_vlm.trainer.sft_trainer import TrainingArgs, train
...
class TestDataset(unittest.TestCase):
    ...
    @patch("xmlx_vlm.trainer.datasets.apply_chat_template")
    @patch("xmlx_vlm.utils.prepare_inputs")
...
class TestTrainer(unittest.TestCase):
    ...
    @patch("xmlx_vlm.trainer.sft_trainer.iterate_batches")
    @patch("xmlx_vlm.trainer.sft_trainer.mx.save_safetensors")
