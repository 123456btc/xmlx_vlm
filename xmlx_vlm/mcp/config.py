...
CONFIG_SEARCH_PATHS = [
    "~/.config/mlx-vlm/mcp.json",
    "~/.config/mlx-vlm/mcp.yaml",
]

# Environment variable for config path
CONFIG_ENV_VAR = "MLX_MCP_CONFIG"
...
def load_mcp_config(path: Optional[Union[str, Path]] = None) -> MCPConfig:
    ...
    2. MLX_MCP_CONFIG environment variable
    3. ~/.config/mlx-vlm/mcp.json or mcp.yaml
            ...
            if isinstance(server_data, dict):
                ...
                if "skip_security_validation" in server_data:
                    raise ValueError(
                        ...
                        "Use environment variable MLX_MCP_ALLOW_UNSAFE=1 for explicit local development bypasses."
                    )
