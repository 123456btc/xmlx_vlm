...
export const elements = {
    ...
    portfolioModeBadge: document.getElementById('portfolio-mode-badge'),
    portfolioNetworkTag: document.getElementById('portfolio-network-tag'),
    portfolioWalletAddr: document.getElementById('portfolio-wallet-addr'),
    portfolioWalletBox: document.getElementById('portfolio-wallet-box'),
    portfolioEquity: document.getElementById('portfolio-equity'),
    ...
    auditModeBadge: document.getElementById('audit-mode-badge'),
    auditStrategyName: document.getElementById('audit-strategy-name'),
