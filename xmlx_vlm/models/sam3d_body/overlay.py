...
Example:
    from xmlx_vlm.models.sam3d_body.estimator import SAM3DBodyEstimator
    from xmlx_vlm.models.sam3d_body.overlay import render_mesh_overlay, load_faces
...
def render_mesh_overlay(
    ...
    Requires `pyrender` and `trimesh` (optional xmlx-vlm extras).
