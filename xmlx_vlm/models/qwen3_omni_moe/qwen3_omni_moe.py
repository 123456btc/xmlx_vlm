...
from xmlx_vlm.models.qwen3_omni_moe.code2wav import Code2WavModel
from xmlx_vlm.models.qwen3_omni_moe.talker import Talker
from xmlx_vlm.models.qwen3_omni_moe.thinker import Thinker
...
class Model(nn.Module):
    ...
    def generate(
        ...
        **kwargs,
        ...
        if not return_audio:
            from xmlx_vlm.generate import generate_step
