...
def main():
    ...
    Usage:
        python -m xmlx_vlm.models.rfdetr.generate --task detect --image photo.jpg --model ./rfdetr-base-mlx
        python -m xmlx_vlm.models.rfdetr.generate --task segment --video traffic.mp4 --model ./rfdetr-seg-small-mlx
        python -m xmlx_vlm.models.rfdetr.generate --task realtime --model ./rfdetr-base-mlx
        python -m xmlx_vlm.models.rfdetr.generate --task realtime --video traffic.mp4 --model ./rfdetr-seg-small-mlx
    """
    import argparse
