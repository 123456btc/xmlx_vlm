...
from xmlx_vlm.utils import load_model
from xmlx_vlm.models.rfdetr.processing_rfdetr import RFDETRProcessor
from xmlx_vlm.models.rfdetr.generate import RFDETRPredictor

# Load model (uses the standard xmlx-vlm loader)
...
```bash
# Detection
python -m xmlx_vlm.models.rfdetr.convert --variant base --output ./rfdetr-base-mlx
python -m xmlx_vlm.models.rfdetr.convert --variant small --output ./rfdetr-small-mlx
python -m xmlx_vlm.models.rfdetr.convert --variant large --output ./rfdetr-large-mlx

# Segmentation (detection + instance masks)
python -m xmlx_vlm.models.rfdetr.convert --variant seg-small --output ./rfdetr-seg-small-mlx
python -m xmlx_vlm.models.rfdetr.convert --variant seg-large --output ./rfdetr-seg-large-mlx
```
