...
"""
Runtime patch for xmlx-vlm's Gemma 4 attention to support BatchKVCache.
...
def patch_gemma4_attention_for_batching() -> bool:
    ...
    Returns True if patch was applied, False if xmlx-vlm is not installed
    or Gemma 4 module not available.
    """
    try:
        from xmlx_vlm.models.gemma4.language import Attention as Gemma4Attention
        from xmlx_vlm.models.base import scaled_dot_product_attention
    except ImportError:
        logger.debug("[Gemma4 patch] xmlx-vlm Gemma4 module not available")
        return False
