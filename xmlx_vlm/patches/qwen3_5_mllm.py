...
"""
Runtime patch for xmlx-vlm's Qwen3.5 attention to support BatchKVCache.

xmlx-vlm's Qwen3_5Attention uses cache.offset directly for kv_seq_len
...
def patch_qwen35_attention_for_batching() -> bool:
    ...
    """
    try:
        from xmlx_vlm.models.qwen3_5.language import (
            Qwen3_5Attention,
