...
"""
Runtime patch for xmlx-vlm's GLM-4.6V model to support BatchKVCache.
...
def patch_glm4v_moe_for_batching() -> bool:
    ...
    """
    try:
        from xmlx_vlm.models.glm4v_moe.language import (
            GLM4VModel,
            create_attention_mask,
        )
    except ImportError:
        logger.debug("[GLM4V patch] xmlx-vlm glm4v_moe module not available")
        return False
